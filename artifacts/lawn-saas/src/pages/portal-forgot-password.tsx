            ...
            {!submitted ? (
              ...
              <div className="text-center py-4">
                ...
                <p className="text-sm text-muted-foreground">
                  If <span className="font-semibold text-foreground">{email}</span> has a portal account, a reset link has been sent. It expires in 1 hour.
                </p>
              </div>
            )}
            <div className="mt-6 text-center text-sm">
              <Link href={`/portal/${slug}/login`} className="inline-flex items-center gap-1 text-primary font-medium hover:underline">
