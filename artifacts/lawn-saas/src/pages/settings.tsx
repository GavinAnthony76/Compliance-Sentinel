            ...
            <form onSubmit={handleSavePayments} className="space-y-6 max-w-2xl">
              <div>
                ...
                <div className="mb-3 p-3 rounded-xl bg-blue-50 border border-blue-200 text-xs text-blue-800">
                  <strong>Note:</strong> Card (Online) enables a Stripe-hosted payment link in the customer portal for Growth and Pro plans. All other methods (Cash, Check, Zelle, Venmo, Cash App) are collected and reconciled outside this app — GreenSync does not process or hold funds directly.
                </div>
